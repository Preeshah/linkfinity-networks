                ...
                <>
                    ...
                    >
                        ...
                        <input
                            ...
                            className="text-gray-600 w-full rounded-xl border border-gray-300 px-4 py-3"
                        ...
                        <button
                            ...
                            className="w-full rounded-xl bg-blue-600 hover:bg-blue-700 text-white py-4 font-semibold"
